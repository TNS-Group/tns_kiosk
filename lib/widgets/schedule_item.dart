...
import 'package:tns_kiosk/constants.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [Theme.of(context).colorScheme.surfaceContainer, Colors.blue],
        ),
      ),
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "${weekday.label.toUpperCase().substring(0, 3)}  ${formatTimeOfDay(start)} - ${formatTimeOfDay(end)}",
            ),
          ],
        ),
      ),
